	...
	<div>
		...
		<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				...
				<router-link to="/dashboard/v2" class="navbar-brand"><span class="navbar-logo"></span> <b>Banian</b> </router-link>
				...
				<li class="dropdown navbar-user">
					<b-dropdown variant="link" menu-class="dropdown-menu-right">
						<template slot="button-content">
							...
							<span class="d-none d-md-inline">张三</span> <b class="caret"></b>
						</template>
